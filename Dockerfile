...
#COPY toolchains_path.py .
#RUN    apt-get update && apt-get install -y make
#RUN 	python /opt/android-sdk-linux/ndk-bundle/build/tools/make_standalone_toolchain.py \
#        --arch arm64 --api 26 --install-dir /toolchain_aarch64 \
#        && python /opt/android-sdk-linux/ndk-bundle/build/tools/make_standalone_toolchain.py \
#        --arch x86 --api 26 --install-dir /toolchain_x86
